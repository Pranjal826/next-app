...
Step by step guide for free property listing</h1>
        ...
        <div className="img bg-[url('https://plus.unsplash.com/premium_photo-1670274229211-a46356f9d196?q=80&w=3432&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] w-full h-[55vh] bg-cover bg-no-repeat relative flex items-center justify-center ">
            <div className="para w-[80%] h-auto bg-slate-50 p-[20px] border-t-[1px] border-b-[10px] border-l-[5px] border-r-[5px] border-fuchsia-200 rounded absolute top-[40%]">
            ...
            <button className="absolute top-[75vh] bg-blue-800 text-white pl-10 pr-10 pt-3 pb-3 rounded-[12px]">
